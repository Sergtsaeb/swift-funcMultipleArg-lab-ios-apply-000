 ...
 */
func continental(continent: String, numberOfCountries: Int) {
 ...
 */
func Dranks(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place)")
}

Dranks("beer", numberOfBottles: 6, place: "bus")
